...
st.set_page_config(page_title="AirBnb-Analysis by Nithish Kumar!!!", page_icon=":bar_chart:", layout="wide")
...
SELECT = option_menu(
    menu_title=None,
    options=["Home", "Explore Data", "Tablue Dashboard"],
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir("C:/Users/yuva6/Nithish")
